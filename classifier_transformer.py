...
class Transformer_Model(nn.Module):
    def __init__(self, n_features):
        ...
        self.pos_encoder = nn.PositionalEncoding(n_features, dropout)
        encoder_layers = TransformerEncoderLayer(n_features, nhead, nhid, dropout)
        self.transformer_encoder = TransformerEncoder(encoder_layers, n_layers)
        self.decoder = nn.Linear(n_features, 10)
...
class Classifier_Transformer(supervised_classifier.Supervised_Classifier):
    def __init__(self,
                 dataset,
        ...
        super(Classifier_Transformer, self).__init__(dataset, type_prediction, results_dir,
    ...
    def init_model(self, embedding_model, hyper_params):
        ...
        self.set_model(Transformer_Model(self.n_features).to(self.device))
    ...
    def train(self, training_data, valid_data, model_path, batch_size=100, epochs=10):
        ...
        training_data_set = Transformer_Dataset(training_data)
