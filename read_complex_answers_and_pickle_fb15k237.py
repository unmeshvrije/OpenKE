...
def parse_args():
    ...
    default = '/home/xxx/OpenKE/benchmarks/fb15k237/train2id.txt')
    parser.add_argument('--validfile', dest ='valid_file', type = str, help = 'File containing valid triples.',
    default = '/home/xxx/OpenKE/benchmarks/fb15k237/valid2id.txt')
    ...
    default = "/var/scratch2/xxx/OpenKE-results/fb15k237/data/fb15k237-transe-test-topk-10.json"
)
