...
PARAMS_SNORKEL_HEAD="--name_signals mlp_multi,lstm,conv,path,sub --snorkel_low_threshold 0.3,0.3,0.3,0,0 --snorkel_high_threshold 0.7,0.7,0.7,0.5,0.5"
PARAMS_SNORKEL_TAIL="--name_signals mlp_multi,lstm,conv,path,sub --snorkel_low_threshold 0.3,0.3,0.3,0,0 --snorkel_high_threshold 0.7,0.7,0.7,0.5,0.5"
PARAMS_MLP_HEAD="--mlp_dropout 0.1 --mlp_n_hidden_units 1000"
PARAMS_MLP_TAIL="--mlp_dropout 0.1 --mlp_n_hidden_units 1000"
PARAMS_LSTM_HEAD="--lstm_dropout 0.1 --lstm_n_hidden_units 1000"
PARAMS_LSTM_TAIL="--lstm_dropout 0.1 --lstm_n_hidden_units 1000"
PARAMS_CONV_HEAD="--conv_kern_size1 4 --conv_kern_size2 2"
PARAMS_CONV_TAIL="--conv_kern_size1 4 --conv_kern_size2 2"
