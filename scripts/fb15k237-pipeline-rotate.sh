...
PARAMS_MLP_HEAD="--mlp_dropout 0.3 --mlp_n_hidden_units 1000"
...
PARAMS_CONV_HEAD="--conv_kern_size1 6 --conv_kern_size2 3"
PARAMS_CONV_TAIL="--conv_kern_size1 6 --conv_kern_size2 2"
PARAMS_SUB_HEAD="--sub_k 3"
PARAMS_SUB_TAIL="--sub_k 3"
PARAMS_THRESHOLD_K_HEAD="--threshold_k 2"
PARAMS_THRESHOLD_K_TAIL="--threshold_k 2"
