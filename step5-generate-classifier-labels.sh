...
# Uncomment this line and give the path to the LibKGE installation
#export PYTHONPATH="${PYTHONPATH}:/path/to/LibKGE/installation"

# Result Directory
RD=$1 # "/Users/jacopo/Desktop/data_unmesh/"
E=$2
DB=$3
DR=0.2
