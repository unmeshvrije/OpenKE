...
def parse_args():
    ...
    parser.add_argument('--trainfile', dest ='train_file', required = True, type = str, help = 'File containing test data.')
...
if args.classifier == "mlp":
    ...
    mys = SubgraphClassifier(args.pred, args.topk, queries_file_path, emb_file, sub_file, subemb_file, args.model, args.train_file)
    mys.predict()
    mys.results()
