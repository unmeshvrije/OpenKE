...
def parse_args():
    ...
    parser.add_argument('--embfile', dest ='emb_file', required = True, type = str, help = 'File containing entity embeddings.')
...
mys = SubgraphClassifier("tail", 10, triples_file_path, emb_file, sub_file, subemb_file)
mys.predict()
mys.results()
