...
def parse_args():
    ...
    parser.add_argument('--dyntopk-spo', dest = 'dyntopk_spo', type = str, default = "/var/scratch/uji300/OpenKE-results/fb15k237/misc/fb15k237-dynamic-topk-tail.pkl")
    parser.add_argument('--dyntopk-pos', dest = 'dyntopk_pos', type = str, default = "/var/scratch/uji300/OpenKE-results/fb15k237/misc/fb15k237-dynamic-topk-head.pkl")
    ...
    parser.add_argument('--entdict', dest ='ent_dict', type = str, default = '/var/scratch/uji300/OpenKE-results/fb15k237/misc/fb15k237-id-to-entity.pkl',help = 'entity id dictionary.')
    parser.add_argument('--reldict', dest ='rel_dict', type = str, default = '/var/scratch/uji300/OpenKE-results/fb15k237/misc/fb15k237-id-to-relation.pkl',help = 'relation id dictionary.')
